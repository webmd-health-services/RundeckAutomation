...
* Rename every file that has `RundeckAutomation` in its name, replacing `RundeckAutomation` with the module name.
* Replaces `RundeckAutomation` in every file with the module name.
